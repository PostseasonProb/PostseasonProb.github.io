window.onload = function() {
  ...
  var strHead = '<nav class="navbar">\n' +
                '  <div class="nav-left"><a href="https://psodds.com/en/index_en.html" class="home-link">Home</a></div>\n' +
                '  <div class="nav-right dropdown">\n' +
                '    <button class="dropbtn">☰</button>\n' + 
                '    <div class="dropdown-content">\n' +
                '      <div class="main-menu-area">\n' +
                '        <a href="https://psodds.com/en/2025_en.html" class="new-season">2025 Season</a>\n' +
                '        <a href="https://psodds.com/en/GuideTo_en.html" style="display:inline-block; width:45%;">User Guide</a>\n' +
                '        <a href="https://psodds.com/blog/index.html" style="display:inline-block; width:45%;">PS Odds BLOG\n(Korean!)</a>\n' +
                '      </div>\n' +
