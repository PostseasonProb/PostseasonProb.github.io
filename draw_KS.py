...
#py.plot(fig,filename='KS_2020.html',auto_open=False,config=config)
pio.write_html(fig, file=str(pathlib.Path().resolve())+'/KS_2020.html',auto_open=False,config=config)
